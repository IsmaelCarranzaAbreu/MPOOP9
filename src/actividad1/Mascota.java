...
/**
 * Clase abstracta que construye una Mascota
 * @author alumno
 */
...
public abstract class Mascota extends SerVivo {
    ...
    /**
     * Método que indica que está durmiendo la mascota (No devuelve nada)
     */
    
    public abstract void dormir();
    
    /**
     * Método que indica que está saltando la mascota (No devuelve nada)
     */
    
    public abstract void saltar();
    
    /**
     * Método que indica que está jugando la mascota (No devuelve nada)
     */
