...
/**
 * Clase abstracta que construye un Profesor
 * @author alumno 
 */
...
public abstract class Profesor extends Empleado {
    ...
    /**
     * Método que indica que el profesor está reprobando (No devuelve nada)
     */

    public abstract void reprobar();
    
    /**
     * Método que indica que el profesor está aprobando (No devuelve nada)
     */
    
    public abstract void pasarAlumnos();
    
    /**
     * Método que indica que está explicando el profesor (No devuelve nada)
     */
